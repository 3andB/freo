...
Implemented against [freo-live/api/docs/contract.md at 1116c05](https://github.com/lee-3andB/freo-live/blob/1116c05/api/docs/contract.md) and its strict request validators. The production origin is `https://api.freo.live`; paths include `/v1`. No OpenAPI document or inferred endpoints are used.
