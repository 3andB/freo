(() => {
 const label=document.querySelector('.schedule-mode-status');if(!label||document.getElementById('schedule-studio')||document.getElementById('station-control'))return;
