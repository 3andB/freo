...
class Station(db.Model):
    ...
    radio_browser_uuid = db.Column(db.String(36))
    radio_browser_status = db.Column(db.String(16), nullable=False, default='not_listed', server_default='not_listed')
    radio_browser_error = db.Column(db.String(240), nullable=False, default='', server_default='')
    internet_radio_enabled = db.Column(db.Boolean, nullable=False, default=False, server_default=db.false())
    internet_radio_pending = db.Column(db.Boolean)
    internet_radio_status = db.Column(db.String(16), nullable=False, default='ready', server_default='ready')
    internet_radio_error = db.Column(db.String(240), nullable=False, default='', server_default='')
